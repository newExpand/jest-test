...
test("버튼의 초기 색상이 바른지 확인하고, 클릭시 업데이트 되는지 확인", () => {
    ...
    const colorButton = screen.getByRole("button", { name: "Midnight Blue로 변경" });
    ...
    expect(colorButton).toHaveTextContent("Medium Violet Red로 변경");
});
...
describe("카멜 케이스 대문자 앞에 공백을 삽입하는 테스트", () => {
    test("대문자가 아예 없는 경우", () => {
